export const projects = [
  {
    ...
    features: [
      "Real-time exam systems with optimised synchronisation.",
  ...
  {
    id: "aaeb-tvet",
    title: "AAEB School & TVET College",
    ...
    details: "Led development of Ethiopian government school systems. Implemented multilingual support using i18n internationalisation, RTL layout support, and accessibility (a11y) standards for diverse regional users. Built live exam systems, document viewing modules, and real-time notifications optimised for high-volume concurrent usage (10K+ simultaneous sessions). Integrated Firebase and AWS (S3, Amplify, Cognito) for scalable content distribution, achieving sub-200ms notification delivery.",
  ...
  },
  {
    ...
    details: "An on-demand mobile repair service and e-commerce application. Integrated Firebase notifications, Razorpay payments, Google Maps SDK, and deep linking for location-based order workflows. Reduced APK size from 60MB to 20MB (67% reduction) through image optimisation, resource management, and API-driven dynamic loading. Implemented secure credential storage using React Native Keychain and optimised rendering for low-end Android devices, improving app rating from 3.2 to 4.4 on Play Store.",
    role: "Lead Mobile Developer",
    company: "Resbee Info Technologies Pvt Ltd",
    ...
    challenges: [
      "Initial slow list rendering on low-end Android phones. Resolved by implementing FlatList memoizations and lazy component loading."
    ],
    metrics: {
      downloads: "5K+",
      rating: "4.4",
  ...
  },
  {
    ...
    details: "Built real-time monitoring dashboards using Socket.IO and optimised local caching, achieving sub-100ms sensor data refresh rates. Implemented live sensor alerts and stable device communication for 24/7 uninterrupted production deployment.",
